export const ICONS = {
  tools: `<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
    width="24" height="24" viewBox="0 0 24 24"
    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z" fill="none"/></svg>`,

  storage: `<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
    width="24" height="24" viewBox="0 0 24 24"
    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  admin: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    <path d="M8.024 2.235a76.298 76.298 0 0 0-4.256 1.284.72.72 0 0 0-.492.585c-.831 6.235 1.089 10.785 3.38 13.782a16.05 16.05 0 0 0 3.43 3.35c.519.366.978.63 1.34.8q.27.127.44.176a1.5 1.5 0 0 0 .302.038 1.5 1.5 0 0 0 .15-.038q.166-.049.442-.176c.362-.17.82-.434 1.34-.8a16.05 16.05 0 0 0 3.43-3.35c2.29-2.997 4.21-7.547 3.38-13.782a.72.72 0 0 0-.492-.585c-.976-.32-2.625-.84-4.256-1.284C14.328 1.934 12.796 1.6 12 1.6s-2.328.334-3.976.635zm-.408-1.44C9.235.397 10.965 0 12 0s2.765.397 4.38.894c1.665.45 3.344.982 4.33 1.306a2.31 2.31 0 0 1 1.566 1.893c.894 6.715-1.18 11.692-3.698 14.985a17.25 17.25 0 0 1-3.775 3.68A8.4 8.4 0 0 1 12.37 24c-.42.198-.872.36-1.244.36s-.824-.162-1.244-.36a8.4 8.4 0 0 1-1.572-.938 17.25 17.25 0 0 1-3.775-3.68C1.78 14.89.896 9.913 1.79 3.193A2.31 2.31 0 0 1 3.355 1.3c.987-.324 2.666-.855 4.33-1.305z"/>
  </svg>`,

  externalLink: `<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
    width="24" height="24" viewBox="0 0 24 24"
    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" fill="none"></path>
    <polyline points="15 3 21 3 21 9" fill="none"></polyline>
  ...
  telegram: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  appleMusic: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <rect x="3" y="3" width="18" height="18" rx="5"></rect>
    <path d="M10 16V9l5-1v6"></path>
    <circle cx="8.5" cy="16" r="1.6"></circle>
    <circle cx="13.5" cy="14.5" r="1.6"></circle>
  </svg>`,
